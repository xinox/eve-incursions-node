...
import {ApplicationCommandOptionType, ChannelType, Client, EmbedBuilder, GatewayIntentBits, TextChannel} from 'discord.js';
...
discord.on('interactionCreate', async (interaction) => {
  ...
  if (commandName === 'set-channel') {
    try {
      ...
      if (channel.type !== ChannelType.GuildText) throw new Error('The channel needs to be a TextChannel');
