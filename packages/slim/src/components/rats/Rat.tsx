        ...
        <div className={styles.stats}>
          ...
          <div className={styles.metaGrid}>
            <ul className={styles.metaList}>
              <li><span>Attack Range</span><b>{formatNumber(rat.attackRange ?? 0)} m</b></li>
              <li><span>Orbit Range</span><b>{formatNumber(rat.orbitRange)} m</b></li>
              <li><span>Orbit Speed</span><b>{formatNumber(rat.orbitSpeed)} m/s</b></li>
            </ul>
            <ul className={styles.metaList}>
              <li><span>Chase Speed</span><b>{formatNumber(rat.chaseSpeed)} m/s</b></li>
              <li><span>Signature Radius</span><b>{formatNumber(rat.signatureRadius)} m</b></li>
              <li><span>Scan Resolution</span><b>{formatNumber(rat.scanResolution)} mm</b></li>
            </ul>
          </div>
        </div>
      </div>
